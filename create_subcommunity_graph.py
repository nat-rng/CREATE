...
sub_community_14_nodes = pd.read_pickle('data/graph_files/sub_community_14_ids.pkl')
sub_community_fourteen = G.subgraph(sub_community_14_nodes)
nx.write_graphml(sub_community_fourteen, 'data/graph_files/eth_community_fourteen.graphml')